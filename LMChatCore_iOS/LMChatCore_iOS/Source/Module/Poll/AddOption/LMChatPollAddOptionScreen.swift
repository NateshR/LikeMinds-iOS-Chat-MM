//
//  LMChatPollAddOptionScreen.swift
//  LikeMindsChatCore
//
...
public protocol LMChatAddOptionProtocol: AnyObject {
    func onAddOptionResponse(postID: String, success: Bool, errorMessage: String?)
}

open class LMChatPollAddOptionScreen: LMViewController {
    // MARK: UI Elements
    ...
    public var viewmodel: LMChatPollAddOptionViewModel?
    public var delegate: LMChatAddOptionProtocol?
...
// MARK: LMChatPollAddOptionViewModelProtocol
extension LMChatPollAddOptionScreen: LMChatPollAddOptionViewModelProtocol {
