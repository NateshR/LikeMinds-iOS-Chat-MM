//
//  LMChatMessageLayoutOptions.swift
//  LMChatCore_iOS
//
//  Created by Pushpendra Singh on 28/03/24.
//

import Foundation

/// A typealias of `Set<ChatMessageLayoutOption>` to make the API similar of an `OptionSet`.
public typealias LMChatMessageLayoutOptions = Set<LMChatMessageLayoutOption>

extension LMChatMessageLayoutOptions: Identifiable {
...
public extension LMChatMessageLayoutOptions {
    /// Remove multiple message layout options.
    mutating func remove(_ options: LMChatMessageLayoutOptions) {
        self = subtracting(options)
    }
    
    /// Insert multiple message layout options.
    mutating func insert(_ options: LMChatMessageLayoutOptions) {
...
public struct LMChatMessageLayoutOption: RawRepresentable, Hashable, ExpressibleByStringLiteral {
...
public extension LMChatMessageLayoutOption {
