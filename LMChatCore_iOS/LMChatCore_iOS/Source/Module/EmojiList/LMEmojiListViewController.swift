//
//  LMEmojiListViewController.swift
//  LMChatCore_iOS
//
...
protocol LMEmojiListViewDelegate: AnyObject {
    func emojiSelected(emoji: String, conversationId: String?)
}

open class LMEmojiListViewController: LMViewController {
    ...
    weak var delegate: LMEmojiListViewDelegate?
    ...
    lazy var collectionView: LMCollectionView = {
        ...
        collection.register(LMEmojiCollectionCell.self, forCellWithReuseIdentifier: "LMEmojiCollectionCell")
...
extension LMEmojiListViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "LMEmojiCollectionCell", for: indexPath) as! LMEmojiCollectionCell
